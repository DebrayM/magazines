        ...
        <div class="col-md-1 col-lg-2 divLeft d-flex align-items-center justify-content-end position-relative p-0"></div>
            <div class="col-xs-12 col-md-10 col-lg-8 bgRow">
                <div class="row bgGrey">
                    <div>
                        <h1>Magazines</h1>
                        <h2>Liste des magazines d'un éditeur</h2>
                    </div>
                 </div>
                <!-- colonne centrale -->
                <div class="row bgRow">
                    <!-- container central -->
                    <div class="col-xs-12 col-md-8 col-lg-12 d-flex flex-column justify-content-center">
                       <?php
                            if ($_SERVER["REQUEST_METHOD"] == "GET") {
                                ...
                                if($flag){                                            
                                    ...
                                    // tous les magazines pour un éditeur //
                                     echo chargeTableauEditeur($_GET["id"]);
                                }
                             }
                        ?>
                    </div>
